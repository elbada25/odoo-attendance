...
if EXISTING_DIR="$(get_install_dir 2>/dev/null)"; then
    CHOICE=$(zenity --forms --title="Odoo Attendance - Instalador  v1.0.1" \
...
H4sIAGtliGoC/+2963LbSLIg3L8Z4XeohaNXgE1CJHWxzRn2GdmSbc3Iko8kT0+vWkGDJChiBAIc
...

